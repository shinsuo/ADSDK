...
@interface PBASIInputStream : NSObject {
	NSInputStream *stream;
	PBASIHTTPRequest *request;
}
+ (id)inputStreamWithFileAtPath:(NSString *)path request:(PBASIHTTPRequest *)request;
+ (id)inputStreamWithData:(NSData *)data request:(PBASIHTTPRequest *)request;

@property (retain, nonatomic) NSInputStream *stream;
@property (assign, nonatomic) PBASIHTTPRequest *request;
@end
