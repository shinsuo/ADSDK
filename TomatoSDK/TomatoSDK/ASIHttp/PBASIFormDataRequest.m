...
// Private stuff
@interface PBASIFormDataRequest ()
...
@implementation PBASIFormDataRequest
...
- (void)addFile:(NSString *)filePath withFileName:(NSString *)fileName andContentType:(NSString *)contentType forKey:(NSString *)key
{
	...
	if (!fileExists || isDirectory) {
		[self failWithError:[NSError errorWithDomain:PBNetworkRequestErrorDomain code:PBASIInternalErrorWhileBuildingRequestType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"No file exists at %@",filePath],NSLocalizedDescriptionKey,nil]]];
	}
	...
	if (!contentType) {
		contentType = [PBASIHTTPRequest mimeTypeForFileAtPath:filePath];
	}
...
{
	PBASIFormDataRequest *newRequest = [super copyWithZone:zone];
